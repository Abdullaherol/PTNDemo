...
public class Grid2D : MonoBehaviour
{
    ...
    public List<Node2D> GetNeighbors(Node2D node)
    {
        ...
        if (node.gridPosition.x >= 0 && node.gridPosition.x < worldSize.x && node.gridPosition.y + 1 >= 0 && node.gridPosition.y + 1 < worldSize.y)
            neighbors.Add(grid[node.gridPosition.x, node.gridPosition.y + 1]);

        if (node.gridPosition.x >= 0 && node.gridPosition.x < worldSize.x && node.gridPosition.y - 1 >= 0 && node.gridPosition.y - 1 < worldSize.y)
            neighbors.Add(grid[node.gridPosition.x, node.gridPosition.y - 1]);

        if (node.gridPosition.x + 1 >= 0 && node.gridPosition.x + 1 < worldSize.x && node.gridPosition.y >= 0 && node.gridPosition.y < worldSize.y)
